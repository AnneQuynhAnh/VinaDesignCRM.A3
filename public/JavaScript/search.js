document.addEventListener("DOMContentLoaded", function () {
  ...
  function createOrderDiv(order) {
    ...
    productInfo.textContent = `Sản phẩm: ${order.product_name || "null"}`;
    ...
    // Set the button text based on the status from the database
    statusBtn.textContent = order.status || "Chưa cập nhật"; // Display the status or "Chưa cập nhật" if null
